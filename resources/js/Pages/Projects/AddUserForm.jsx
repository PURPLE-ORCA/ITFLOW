          ...
          <div className="max-w-xl mx-auto backdrop-blur-lg bg-slate-400/5 border border-white/20 rounded-xl">
            ...
            <div className="p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-200">Rôle dans l'équipe</label>
                  <select
                    value={data.role}
                  ...
                  >
                    ...
                    <option value="développeur" className="bg-gray-900">Développeur</option>
                    <option value="designer" className="bg-gray-900">Designer</option>
                    <option value="testeur" className="bg-gray-900">Testeur</option>
                    <option value="analyste" className="bg-gray-900">Analyste</option>
                  </select>
                  {errors.role && (
