        ...
        <div className="h-full bg-black/90 backdrop-blur-lg rounded-2xl p-6 text-white  min-h-full">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center text-gray-300">
              ...
              <span>{task.due_date ? formatDate(task.due_date) : 'Pas de date limite'}</span>
            </div>
            ...
            {isPending ? (
              ...
              <div className="flex items-center text-gray-300">
                ...
                <span>Complété le {formatDate(task.confirmation?.created_at)}</span>
              </div>
            )}
          ...
          <>
            {finishedTasks.length > 0 ? (
              ...
              <div className="col-span-full flex items-center justify-center p-8 rounded-xl bg-gray-800/50">
                <div className="text-center">
                  <ExclamationCircleIcon className="w-12 h-12 text-gray-400 mx-auto mb-3" />
                  <p className="text-gray-400">Aucune tâche terminée pour l'instant ! 💪</p>
                </div>
              </div>
            )}
          </>
